...
For each (firm, year, report) we compute a small number of report-level features describing the document's overall structure and writing style. They are stored alongside the extracted ESG indicators and are displayed in the dashboard as a single row per report. The features fall into three groups:
