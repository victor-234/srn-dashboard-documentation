...
link-citations: true
abstract: |
  This whitepaper documents the automated Transparency dimension and environmental, social, and governance (ESG) indicator extraction pipeline   of the Sustainability Reporting Navigator (SRN). The Transparency dimension pipeline captures textual characteristics such as length and readibility as well as environmental and social topic shares. The ESG indicator pipeline retrieves
